...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/root/notebooks/nfs/work/dataset/imagenet2012')
    ...
    net = get_network(args, 1000, device)
    ...
    train_loader = DataLoader(train_ds, batch_size=args.b, num_workers=4, shuffle=True, pin_memory=True)
    val_loader = DataLoader(val_ds, batch_size =args.b, num_workers=4, shuffle=False, pin_memory=True)
